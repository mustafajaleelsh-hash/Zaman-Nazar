        ...
        <footer className="bg-background text-foreground border-t border-border pt-20 pb-10">
            <div className="container mx-auto px-6 md:px-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        <h3 className="text-sm tracking-widest uppercase text-foreground mb-6 font-semibold">Collections</h3>
                    ...
                    <div>
                        <h3 className="text-sm tracking-widest uppercase text-foreground mb-6 font-semibold">Customer Care</h3>
                        <ul className="space-y-4 text-sm text-foreground/70">
                    ...
                    <div>
                        <h3 className="text-sm tracking-widest uppercase text-foreground mb-6 font-semibold">Join the Club</h3>
                        ...
                        <form className="flex mb-6">
                            <input
                                ...
                                className="bg-transparent border-b border-border px-0 py-2 text-sm text-foreground w-full focus:outline-none focus:border-gold-500 transition-colors"
                            />
                            <button type="submit" className="border-b border-border text-gold-500 hover:text-foreground transition-colors uppercase tracking-widest text-xs px-2">
                                Subscribe
                            </button>
                        </form>
                ...
                <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-foreground/50 tracking-wider">
